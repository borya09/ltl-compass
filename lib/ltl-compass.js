(function (exports, process, undefined) {
	...
	exports.compile = (function () {
		...
		var _prepareOptions = function () {
			...
			//OUTPUT
			_opts.output_path = _opts.output_path || supportedOpts.output_path.default;
			...
			//TMP
			_opts.tmp_dir = (_opts.output_dir === './' ? '' : _opts.output_dir) + tmp_path + path_separator;
			_opts.tmp_name = _opts.output_name;
		};

		var _removeTmpFolder = function (opts) {
			fs.removeSync(opts.tmp_dir);
		};
